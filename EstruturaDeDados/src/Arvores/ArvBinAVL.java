...
/*		Implementacao - Arvore Binaria Balanceada AVL - 
 * 	Autor: Luiz Fernando ( luizfcneto )
 * 	Email: luizfcneto123@gmail.com
 * 	Descricao: Implementacao da estrutura de dados Arvore Binaria de 
 * 		Busca Balanceada AVL
 * 
 * 	- Atributos:
...
public class ArvBinAVL extends ArvBinBusca{
	...
	//Retorna a chave de menor valor a partir de um no desejado.
	...
	//Remove elemento minimo de uma subarvore do do no auxiliar especifico
