package Pilha;
/*
 * 		Classe de estrutura de dados: Pilha Generica
 * 	Autor: Luiz Fernando (Luizfcneto)
 * 	Email: devluizfcneto@gmail.com
 * 	Descricao: Implementacao do algoritmo de manipulacao de uma pilha 
 * 	generica
...
public class PilhaGenerica<T> {
	...
	//Metodo para facilitar visualizacao: Printar toda a pilha
