 ...
 * 		
 * 	Descricao:	Esta classe eh responsavel pela implementacao da estrutura Lista Encadeada
 ...
 * 		utilizada ( para nao corromper esses dados ao fazer as manipulacoes ).
 * 		
 * 		Essa referencia apontara para uma outra classe aninhada denotada de Elo (ou No) da Lista que tera dois campos (atributos)
 * 		o conteudo, e uma referencia para o proximo Elo ( Elemento ).		
 * 
 *
 * 		Ao adicionarmos um Elo na lista, na pratica estamos criando um Elo e referenciando ele a primeira posicao da Lista. 
 ...
 * 	
 * 	Metodos:
 * 		- listaVazia();							//verifica se lista esta vazia, quando o primeiro referencia a nulo;
 * 		- tamanhoDaLista (); 
 * 		- insereNaLista ( Elo );	
 * 		- removeDaLista ( conteudo )			//Criterios podem ser posicao da Lista, ou por conteudo dos Elos
 * 		- buscaConteudoNaLista ( conteudo )
 * 		- printaListaEncadeada 					//Para fins didaticos e termos uma melhor visualizacao dos Elementos da lista
 */
...
public class ListaEncadeada {
	...
	public void insereNaLista ( int conteudoNovo ) {
		...
		//o elemento novo ira apontar para nulo, que ira apontado por this.primeiro.proximo
	...
	//Remove um elemento da Lista Encadeada ( por conteudo! ) ATENTAR AO FATO DE REMOVER O PRIMEIRO ELEMENTO!
