 ...
 * 		
 * 		Essa referencia apontará para uma outra classe aninhada denotada de Elo (ou No) da Lista que terá dois 
 * 		campos (atributos) o conteudo, e uma referencia para o proximo Elo ( Elemento ).		
 * 		
 * 
 * 	Atributos:
 * 		- Elo primeiro;
...
public class ListaEncadeada {
	...
	public int tamanhoListaEncadeada() {
		return 0;
	}
